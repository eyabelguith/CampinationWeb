...
class NouveauCamper
{
    ...
    public function notify()
    {
      ...
      ->setUsername('eyatalbi03@gmail.com')
      ->setPassword('213JFT4521');

       $this->mailer = new Swift_Mailer($transport);

       $body = 'Hello, <p> un nouveau Camper a été inscrit  <span style="color:red;"> ajoutée</span>.</p>';

        // On construit le mail
        $message = (new Swift_Message('Consulter votre forum il y a une nouvelle publication !!'))
      ->setFrom(['eyatalbi03@gmail.com' => 'CampinationApp notifier'])
      ->setTo(['eya.talbi@esprit.tn'])
